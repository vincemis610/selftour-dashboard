$(document).ready(function() {
    ...
    $('#advance-8').DataTable({
        "language": {
            "url": "/dashboard/assets/json/German.json"
        }
    });
    $('#advance-9').DataTable({
        "searching": false,
    ...
    $('#data-source-4').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "/dashboard/assets/json/server-side.json"
    } );
    ...
    var ct = $('#API-chield-row').DataTable({
        "ajax": "/dashboard/assets/ajax/api.txt",
        "columns": [{
    ...
    $('#ajax-data-array').DataTable({
        "ajax": "/dashboard/assets/ajax/arrays.txt",
    });
    //Ajax Data Source (Arrays) start 
    //Ajax Data Source (object) start             
    $('#ajax-data-object').DataTable({
        "ajax": "/dashboard/assets/ajax/object.txt",
        "columns": [{
            "data": "name"
        }, {
            "data": "position"
    ...
    $('#ajax-data-nested-object').DataTable({
        "processing": true,
        "ajax": "/dashboard/assets/ajax/object_nested.txt",
        "columns": [{
            "data": "name"
            }, {
                "data": "hr.position"
    ...
    $('#orthogonal-data').DataTable({
        ajax: "/dashboard/assets/ajax/orthogonal.txt",
        columns: [{
            data: "name"
        }, {
            data: "position"
    ...
    $('#server-side-datatable').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "/dashboard/assets/ajax/server-processing.php"
    });
    ...
    $('#datatable-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "/dashboard/assets/ajax/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
            }
        },  
    ...
    $('#datatable-post').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "/dashboard/assets/ajax/post.php",
            type: "post"
        },
        "columns": [{
            "data": "first_name"
